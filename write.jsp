			...
			<!-- 화면을 12개로 나눠 전체적인 크기를 맞추기 위한 div. 2-8-2로 나누었다. -->
				...
				<div class="col-md-8">		<!-- 본문 -->
					...
					%>
						...
						<!-- submit하면 write_process.jsp를 실행한다. 제목, 카테고리, 작성자, 비밀번호, 이메일과 내용을 넘긴다. -->

							<div class="form-group">
								<label for="form-title">제목</label>
								<input type="text" name="title" class="form-control" id="form-title" required autofocus>
							</div>

							<div class="form-group">
								<label for="form-category">카테고리</label>
								<input type="text" name="category" class="form-control" id="form-category" required>
		                    </div>

		                    <div class="form-group">
			                    <label for="form-writer">작성자</label>
								<input type="text" name="writer" class="form-control" id="form-writer" required>
		                    </div>

		                    <div class="form-group">
			                    <label for="form-password">비밀번호</label>
								<input type="password" name="password" class="form-control" id="form-password" placeholder="8~12글자로 영어및숫자" pattern="[A-Za-z0-9]{8,12}" required>
		                    </div>
		                    ...
		                    <div class="form-group">
			                    ...
			                    <textarea rows="10" name="content" class="form-control" id="form-content" required></textarea>
		                    </div>
	                ...
	                <%
	                	...
	                	{
	                %>
						<form action=write_process.jsp?idx=<%=param_idx%> method="post">
